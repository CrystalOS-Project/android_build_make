...
def mangle_build_prop(prop_list, kernel_version_file_for_uffd_gc):
  # If ro.debuggable is 1, or ro.adb.secure is 0, then enable adb on USB by default
  # (this is for userdebug builds)
  if prop_list.get_value("ro.debuggable") == "1" or prop_list.get_value("ro.adb.secure") != "0":
